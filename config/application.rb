...
module Bookyt
  class Application < Rails::Application
    ...
    config.active_record.observers = :booking_import_observer
    ...
    config.action_view.javascript_expansions[:defaults] += %w(jquery-ui cyt tooltip jquery.form jquery.remotipart jquery.dirtyform)
