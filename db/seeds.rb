...
ChargeRate.create!([
  ...
  {:code => 'salary:employer:bu', :title => "BU", :duration_from => '2007-01-01', :duration_from => '2014-01-01', :rate => 0.071},

  {:code => 'salary:employee:nbu', :title => "NBU", :duration_from => '2010-07-01', :duration_from => '2014-01-01', :rate => 0.951},
  {:code => 'salary:employer:nbu', :title => "NBU", :duration_from => '2010-07-01', :duration_from => '2014-01-01', :rate => 0},
...
ChargeBookingTemplate.create!([
  ...
  {:code => "salary:employee:nbu", :charge_rate_code => 'salary:employee:bu', :title => "BU Arbeitnehmner", :debit_account => Account.find_by_code("2020"), :credit_account => Account.find_by_code("5000"), :amount_relates_to => 'reference_amount'},
  {:code => "salary:employer:nbu", :charge_rate_code => 'salary:employer:bu', :title => "BU Arbeitgeber", :debit_account => Account.find_by_code("2020"), :credit_account => Account.find_by_code("5700"), :amount_relates_to => 'reference_amount'},
  ...
  {:code => "salary:employer:vkb", :charge_rate_code => 'salary:employer:fak', :title => "VKB Arbeitgeber", :debit_account => Account.find_by_code("2020"), :credit_account => Account.find_by_code("5700"), :amount_relates_to => 'reference_amount'},
])
